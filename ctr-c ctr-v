...
?>
    ...
    <header>
      ...
      <nav>
        <ul>
          <li><a class="brick dashboard" href="/projecte2.2.2/index.php?controlador=Treballadors&accion=treballadors"> <img src="usuario(1).png" width="3px" height="4px" span class='icon ion-home'></span>Llistat Treballadors</a></li>
