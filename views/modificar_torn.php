...
<body>
    ...
    <input type="hidden" name=controlador value=Torn>
    <input type="hidden" name=accion value=gravar_modificacio>
        ...
        <table>
            ...
            <td><a href="index.php?controlador=Torn&accion=formulario_modificar&param=<?php echo $item["id_treballador"] ?>">Editar </a></td><a href="">Eliminar</a></td>
                </tr> <?php
